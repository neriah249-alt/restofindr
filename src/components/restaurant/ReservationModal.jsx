      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <motion.div
            ...
            className="w-full max-w-md rounded-3xl shadow-2xl p-6 bg-white"
          >
            {/* En-tête */}
            <div className="flex justify-between items-center mb-4">
              <h2 className="font-display text-xl font-bold text-darkText">
                📅 Réservation
              </h2>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl outline-none transition bg-gray-50 text-gray-700 focus:ring-2 focus:ring-primary-500"
                  required
                />
              </div>
